...
public class SingerAdapter extends
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.ivImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:"+ dto.getMobile()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tvName, tvMobile, tvLocation;
        ...
        public ViewHolder(@NonNull View itemView, OnSingerItemClickListener listener) {
            ...
            tvLocation = itemView.findViewById(R.id.tvLoction);
        ...
        public void setDto(SingerDTO dto){
            ...
            tvLocation.setText(dto.getLocation());
